    ...
    public partial class First : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TB_T_Histories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TB_T_Histories_TB_M_Cases_CaseId",
                        column: x => x.CaseId,
                        principalTable: "TB_M_Cases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TB_T_Histories_TB_M_StatusCodes_StatusCodeId",
                        column: x => x.StatusCodeId,
                        principalTable: "TB_M_StatusCodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TB_T_Histories_TB_M_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "TB_M_Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TB_T_Histories_CaseId",
                table: "TB_T_Histories",
                column: "CaseId");

            migrationBuilder.CreateIndex(
                name: "IX_TB_T_Histories_StatusCodeId",
                table: "TB_T_Histories",
                column: "StatusCodeId");

            migrationBuilder.CreateIndex(
                name: "IX_TB_T_Histories_UserId",
                table: "TB_T_Histories",
                column: "UserId");
        }
