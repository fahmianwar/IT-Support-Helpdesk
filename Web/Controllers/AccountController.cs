    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Login()
        {
            if (HttpContext.Session.IsAvailable)
            {
                ...
                {
                    return Redirect("~/Views/Shared/_LoginLayout.cshtml");
                }
            }
            return View();
        }
        [Route("validate")]
        public IActionResult Validate(LoginVM userVM)
        {
        ...
        //public async Task<IActionResult> Test(LoginVM loginVM)
        //{
        ...
        //    return RedirectToAction("pokemon", "home");
        //}
